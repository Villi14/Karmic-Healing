...
public final class KarmicHealingWatchColors: Sendable {
...
public extension KarmicHealingWatchColors.Color {
  @available(iOS 11.0, tvOS 11.0, watchOS 4.0, macOS 10.13, visionOS 1.0, *)
  convenience init?(asset: KarmicHealingWatchColors) {
...
public extension SwiftUI.Color {
  init(asset: KarmicHealingWatchColors) {
    let bundle = Bundle.module
