...
public struct EnergyBalansingSettingsAlertView: View {
  public let store: StoreOf<EnergyBalansingSettingsAlert>
  
  public init(store: StoreOf<EnergyBalansingSettingsAlert>) {
    self.store = store
  }
  ...
  private func durationOptionsView(_ viewStore: ViewStoreOf<EnergyBalansingSettingsAlert>) -> some View {
  ...
  private func durationButton(duration: Int, isSelected: Bool, viewStore: ViewStoreOf<EnergyBalansingSettingsAlert>) -> some View {
    Button(action: {
  ...
  private func vibrationAndSoundSection(_ viewStore: ViewStoreOf<EnergyBalansingSettingsAlert>) -> some View {
    VStack(spacing: DesignConstants.paddingMedium) {
      HStack {
  ...
  private func volumeSection(_ viewStore: ViewStoreOf<EnergyBalansingSettingsAlert>) -> some View {
    VStack(spacing: DesignConstants.paddingMedium) {
      HStack {
  ...
  private func doneButton(_ viewStore: ViewStoreOf<EnergyBalansingSettingsAlert>) -> some View {
    Button(action: {
      viewStore.send(.done)
    }) {
      Text(String(localized: "done", bundle: .main))
        ...
        .background(RoundedRectangle(cornerRadius: DesignConstants.cornerRadiusMedium).fill(ResourcesAsset.Colors.health.swiftUIColor))
    }
  }
} 